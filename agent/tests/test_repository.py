...
class RepositoryTests(unittest.TestCase):
    def test_migration_fk_and_idempotency(self):
        with TemporaryDirectory() as directory:
            ...
            self.assertEqual(migration_versions(connection), ["001", "002", "003", "004", "005"])
            ...
            with connection:
                ...
                repository.register_audit({"id": "V82", "name": "V82", "audit_type": "BLOCKED_OPPORTUNITY", "base_strategy_version": "V26", "mode": "SHADOW", "execution_authority": "NONE", "description": "audit", "status": "RESEARCH_ONLY"})
                ...
                event = NormalizedEvent("fixture.csv", "BLOCKED_SIGNAL", "2025-01-01T00:00:00Z", "2025.01.01 00:00", "UTC", "BTCUSD", "H1", "V26", "V82", "SHORT", "e1", 100.0, None, {"raw_event_type": "BLOCKED_OPPOSITE", "shadow_initial_sl": 102.0, "completed": True}, {"event_id": "e1"})
            ...
            self.assertEqual(len(repository.query_episodes(strategy_version="V26")), 1)
